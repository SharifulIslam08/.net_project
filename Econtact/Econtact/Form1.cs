...
namespace Econtact
{
    public partial class Econtact : Form
    {
        ...
        ContactCtclass c = new ContactCtclass();
        ...
        private void eadd_Click(object sender, EventArgs e)
        {
            ...
            c.ContactID = textBoxContactID.Text;
            ...
            else
            {
                ...
                //MessageBox.Show(c.ContactID,c.ContactNo);
            }
            //Load Data on Data GRidview
            DataTable dt = c.Select();
            dataGridViewresultboard.DataSource = dt;
        }

        private void dataGridViewresultboard_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            //Load Data on Data GRidview
            DataTable dt = c.Select();
            dataGridViewresultboard.DataSource = dt;
